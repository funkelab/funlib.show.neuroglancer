...
This is a modified version of video_tool.py written by Jeremy Maitin-Shepard.
...
class RenderArgs:
    ...
    def __init__(self):
        ...
        self.width = 1920
        self.height = 1080
        self.scale_bar_scale = 1
        self.fps = 5
        self.browser = True
        self.prefetch_frames = 10
...
def run_edit(create_viewer_func, args=RenderArgs()):
    editor = ScriptEditor(
        create_viewer_func=create_viewer_func,
